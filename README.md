...
The simplest method is to place the Seoss33 database zip file at the root of the project and it will be automatically detected. If there are 
...
```
COMPRESSED_DATASET_PATH=absolute_path/to/databases
```